...
class Sparql_Edit
{
    ...
    protected function prepareAnnotation()
    {
    	...
    	$this->graph1->addResource($statement, EasyRdf_Namespace::expand('rdf:object'), $o);$this->graph1->addResource($statement, EasyRdf_Namespace::expand('rdf:object'), $o);// add/addreousrce
